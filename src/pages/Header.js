...
import { logout, redirectToLogin } from '../tech/checking';
        ...
        <ul className="nav nav-pills">
            ...
            <li className="nav-item">
                ...
                <ul class="dropdown-menu">
                    <li><span class="dropdown-item"><b>examplemail</b><span className='text-secondary'>@localhost.com</span></span></li>
                    <li><a class="dropdown-item" href="#">Сменить пароль</a></li>
                    <li><a class="dropdown-item" href="#">Настройки</a></li>
                    <li><hr class="dropdown-divider" /></li>
                    <li><button onClick={handleLogout} class="dropdown-item">Выход</button></li>
                </ul>
                </div>
            </li>
        </ul>
