...
const Restrict = () => {
	...
	<tbody>
      ...
      <button className='position-absolute start-100 btn btn-sm btn-primary rounded-pill' style={{'margin': '0px -6rem'}} ><i className="fas fa-add"></i> </button>
      <button className='position-absolute start-100 btn btn-sm btn-success rounded-pill' style={{'margin': '0px -3rem'}} ><i className="fas fa-save"></i> </button>
    </div>
    );
};
